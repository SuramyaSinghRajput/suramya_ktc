...
<header>
  <h2>📦 Lot Inventory</h2>
  <?php if(in_array($permission['export'] ?? 0, [1,2,3,4,5])): ?>
    <a href="<?php echo e(route('lots.export.form')); ?>" class="add-btn">Export</a>
  <?php endif; ?>

  <?php if(in_array($permission['lots'] ?? 0, [3,4,5])): ?>
  ...
  <div class="tab-content active" id="active-lots">
    ...
    <table class="sortable-table" data-default-sort-index="1" data-default-sort-order="asc">
      ...
      <tbody>
        ...
        <tr 
            <?php if(in_array($permission['lots'] ?? 0, [1, 2, 3, 4, 5])): ?>
                onclick="window.location='<?php echo e(url('admin/lots/details/active/list/' . $value->id)); ?>'" 
        ...
        >
          ...
          <td>
            <?php if(in_array($permission['lots'] ?? 0, [1, 2, 3, 4, 5])): ?>
              <button class="btn btn-sm btn-danger" onclick="event.stopPropagation(); openDeleteModal(<?php echo e($value->id); ?>)">
      ...
      <tfoot>
        <tr style="font-weight: bold; background-color: #f9f9f9;">
          ...
          <td><?php echo e(count($activelots)); ?></td>
          <td><?php echo e($activelots->sum('quantity_bags')); ?></td>
          <td><?php echo e($activelots->sum('remaining_quantity_bags_after_deduction')); ?></td>
          <td></td>
          <td></td>
        </tr>
      </tfoot>
  ...
  <div class="tab-content" id="completed-lots">
    ...
    <table class="sortable-table" data-default-sort-index="2" data-default-sort-order="asc">
      ...
      <tbody>
        ...
        <tr 
            <?php if(in_array($permission['lots'] ?? 0, [1, 2, 3, 4, 5])): ?>
                onclick="window.location='<?php echo e(url('admin/lots/details/complete/list/' . $value->id)); ?>'" 
                style="cursor:pointer;"
            <?php endif; ?>
        >
          <td><?php echo e($value->lot_number); ?></td>
      ...
      <tfoot>
        <tr style="font-weight: bold; background-color: #f9f9f9;">
          <td colspan="1" style="text-align: right;">Total:</td>
          <td><?php echo e(count($completelots)); ?></td>
          <td><?php echo e($completelots->sum('quantity_bags')); ?></td>
          <td><?php echo e($completelots->sum('remaining_quantity_bags_after_deduction')); ?></td>
          <td></td>
          <td></td>
        </tr>
      </tfoot>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u791519547/domains/mrblogician.com/public_html/ktc/resources/views/admin/pages/lots/list.blade.php ENDPATH**/ ?>