    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4 <?php echo e(Metronic::printClasses('aside_menu', false)); ?>"
            ...
            <ul class="menu-nav <?php echo e(Metronic::printClasses('aside_menu_nav', false)); ?>">
                <?php if(in_array($permission['dashboard'], [1,2,3,4,5])): ?>
                ...
                <?php if(in_array($permission['product'], [1,2,3,4,5])): ?>
                ...
                <?php endif; ?>
                <?php if(in_array($permission['warehouse'], [1,2,3,4,5])): ?>
                ...
                <li class="menu-item menu-item-submenu <?php echo $__env->yieldContent('userlist'); ?> <?php echo $__env->yieldContent('userrole'); ?>" aria-haspopup="true"
                    ...
                    <div class="menu-submenu " kt-hidden-height="320" style=""><span
                        ...
                        <ul class="menu-subnav">
                            ...
                            <?php if(in_array($permission['roles'], [1,2,3,4,5])): ?>
                            ...
                            <?php endif; ?>
                            <?php if(in_array($permission['users'], [1,2,3,4,5])): ?>
                ...
                <?php if(in_array($permission['settings'], [1,2,3,4,5])): ?>
...
<?php /**PATH /home/u791519547/domains/mrblogician.com/public_html/ktc/resources/views/admin/layout/base/_aside.blade.php ENDPATH**/ ?>