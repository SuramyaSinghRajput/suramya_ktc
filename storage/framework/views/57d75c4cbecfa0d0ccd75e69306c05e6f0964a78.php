    ...
    <?php else: ?>
        <div class="card">
                            ...
                            <form id="lotForm" action="<?php echo e(url('/admin/lots/details/edit/' . $lots->id)); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="lot_number" class="form-control" value="<?php echo e($lots->lot_number ?? ''); ?>" required>
                                    </div>
                            
                                    <!-- Labour Rate -->
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Labour Rate</label>
                                        <input type="number" step="0.01" name="labour_rate" class="form-control" value="<?php echo e($lots->labour_rate ?? ''); ?>" required>
                                    </div>
                            
                                    <!-- Rent (Item Rate) -->
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Rent</label>
                                        <input type="number" step="0.01" name="product_rate" class="form-control" value="<?php echo e($lots->product_rate ?? ''); ?>" required>
                                    </div>
                            
                                    <!-- Quantity -->
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Quantity Bags</label>
                                        <input type="number" name="quantity_bags" class="form-control" value="<?php echo e($lots->quantity_bags ?? ''); ?>" required>
                                    </div>
                            
                                    <!-- Date -->
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Date</label>
                                        <input type="date" name="date" class="form-control" value="<?php echo e($lots->date ?? ''); ?>" required>
                                    </div>
                            
                                    <!-- Product -->
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Product</label>
                                        <input type="text" name="item" class="form-control" value="<?php echo e($lots->item ?? ''); ?>" readonly>
                                    </div>
                            
                                    <!-- Each Bag Weight -->
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">Each Bag Weight (optional)</label>
                                        <input type="number" step="0.01" name="each_bag_weight" class="form-control" value="<?php echo e($lots->each_bag_weight ?? ''); ?>">
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="packaging_remark" class="form-control" value="<?php echo e($lots->packaging_remark ?? ''); ?>">
                                    </div>
                            
                                    <!-- Existing Media Preview (if any) -->
            ...
            <div id="tab1" class="tab-content active">
                ...
                <div class="row">
                    <div class="col-md-3 info-block"><strong>Total Value</strong> ₹<?php echo e($lots->total_value ?? 'N/A'); ?></div>
                ...
                <a href="javascript:void(0);" class="complete-btn btn btn-success" data-id="<?php echo e($lots->id); ?>">
                    <i class="fas fa-check-circle"></i> Mark Lot as Complete
                </a>
            </div>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\ktc\resources\views/admin/pages/lots/activelotdetail.blade.php ENDPATH**/ ?>