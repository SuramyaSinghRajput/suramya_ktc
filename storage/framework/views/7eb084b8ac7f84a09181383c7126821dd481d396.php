...
<div class="header">
    ...
    <a href="<?php echo e(url('/admin/warehouse/add')); ?>" class="btn-add">+ Add New warehouse</a>
</div>
...
<script>
    ...
    function loadwarehouses(reset = false) {
        $.ajax({
            url: "<?php echo e(route('admin.warehouse.index')); ?>",
            method: "GET",
            data: { page, search },
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u791519547/domains/mrblogician.com/public_html/ktc/resources/views/admin/pages/warehouse/list.blade.php ENDPATH**/ ?>