...
<div class="card">
    <div class="header">
        ...
        <div>
            <?php if(in_array($permission['lots'], [4, 5])): ?>
            ...
            <div id="lotFormModal" class="modal">
                <div class="modal-content">
                    ...
                    <form id="lotForm" action="<?php echo e(url('/admin/lots/details/edit/' . $lots->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="lot_number" value="<?php echo e($lots->lot_number); ?>" class="form-control" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="product_id" class="form-select" required>
                                    ...
                                    <option value="<?php echo e($product->id); ?>" <?php echo e($product->id == $lots->product_id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" value="<?php echo e($lots->labour_rate); ?>" step="0.01" name="labour_rate" class="form-control" required>
                            </div>

                            <!-- Rent -->
                            <div class="col-md-6 mb-3">
                                <label>Rent</label>
                                <input type="number" step="0.01" value="<?php echo e($lots->warehouse_rate); ?>" name="rent" class="form-control" required>
                            </div>

                            <!-- Quantity -->
                            <div class="col-md-6 mb-3">
                                <label>Quantity</label>
                                <input type="number" name="qty" value="<?php echo e($lots->quantity_bags); ?>" class="form-control" required>
                            </div>

                            <!-- Date -->
                            <div class="col-md-6 mb-3">
                                <label>Date</label>
                                <input type="date" value="<?php echo e($lots->date); ?>" name="date" class="form-control" required>
                            </div>

                            <!-- Each Bag Weight -->
                            <div class="col-md-6 mb-3">
                                <label>Each Bag Weight (optional)</label>
                                <input type="number" value="<?php echo e($lots->each_bag_weight); ?>" step="0.01" name="each_bag_weight" class="form-control">
                            </div>
                            ...
                            <!-- Existing Media -->
                            <?php if($lots->media->count()): ?>
                            <div class="col-md-12 mb-3">
                                <label class="form-label">Existing Media</label>
                                <div class="existing-media d-flex flex-wrap gap-2">
                                    <?php $__currentLoopData = $lots->media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(Str::startsWith($media->media_type, 'image/')): ?>
                                    <img src="<?php echo e(url('storage/app/public/' . $media->media_URL)); ?>" alt="Image" width="100" class="rounded border">
                                    <?php elseif(Str::startsWith($media->media_type, 'video/')): ?>
                                    <video width="120" height="80" controls class="rounded border">
                                        <source src="<?php echo e(url('storage/app/public/' . $media->media_URL)); ?>" type="<?php echo e($media->media_type); ?>">
                                    </video>
                                    <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" value="<?php echo e($lots->packaging_remark); ?>" name="packaging_remark" class="form-control">
                            </div>
    ...
    <div id="tab1" class="tab-content active">
        <div class="row">
            ...
            <div class="col-md-3 info-block"><strong>Current Balance (Bags)</strong>
                <?php echo e($lots->remaining_quantity_bags_after_deduction ?? 'N/A'); ?>

            </div>
            <div class="col-md-3 info-block"><strong>Date Added/Completed</strong>
                <?php echo e(date('d-m-Y', strtotime($lots->date))); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-3 info-block"><strong>Rent</strong>
                <?php echo e($lots->warehouse_rate ?? 'N/A'); ?>

            </div>
            <div class="col-md-3 info-block"><strong>Rent Amount</strong>
                <?php echo e($totalRent ?? 'N/A'); ?>
        ...
        <div class="images d-flex flex-wrap gap-2">
            ...
            <img src="<?php echo e(URL('storage/app/public/' . $image->media_URL)); ?>" alt="Lot Image"
                ...
                onclick="zoomImage('<?php echo e(URL('storage/app/public/' . $image->media_URL)); ?>')">
        ...
        <div class="history">
            <div class="history-timeline">
                <div class="history-entry">
                    <span><?php echo e(date('d-m-Y H:i A', strtotime($lots->created_at))); ?></span>
                ...
                <div class="history-entry">
                    <span><?php echo e(date('d-m-Y H:i A', strtotime($deduction->deduction_date))); ?></span>
    ...
    <div id="tab2" class="tab-content">
        ...
        <table class="table table-bordered table-striped sortable-table" data-default-sort-index="1" data-default-sort-order="asc">
            ...
            <tbody id="deduct-list-body">
                ...
                <tr>
                    ...
                    <td><?php echo e($rent); ?></td>
                    <td><?php echo e(date('d-m-Y', strtotime($deduction->deduction_date))); ?></td>
                    <td>
                        <button type="button" class="btn btn-success btn-sm openEditModal"
                            data-id="<?php echo e($deduction->id); ?>" data-qty="<?php echo e($deduction->qty_bag); ?>"
                            data-gate="<?php echo e($deduction->gate_pass); ?>"
                            data-date="<?php echo e($deduction->deduction_date); ?>"
                            data-lot-id="<?php echo e($deduction->lot_id); ?>">
                            <i class="fa fa-edit"></i> Edit
                        </button>
                        |
                        <!-- Delete Button triggers modal -->
                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#confirmDeleteModal<?php echo e($deduction->id); ?>">
                            <i class="fas fa-trash"></i> Delete
                        </button>

                        <!-- Modal -->
                        <div class="modal fade" id="confirmDeleteModal<?php echo e($deduction->id); ?>" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <form method="POST" action="<?php echo e(route('admin.lots.deduction.destroy', $deduction->id)); ?>">
                                    <?php echo csrf_field(); ?>
                    ...
                    <div class="modal fade" id="editDeductionModal" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <form method="POST"
                                action="<?php echo e(route('admin.lots.deduction.update', $deduction->id)); ?>">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" name="ddd" id="edit_date"
                                                class="form-control" min=<?php echo e($minDate); ?> required>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                ...
                <tr>
                    <td colspan="6">
                        Total Bags: <?php echo e($deductionList->sum('qty_bag')); ?><br>
                        <strong>Total Rent: ₹<?php echo e($totalRent); ?></strong>
                    </td>
                </tr>
            </tbody>
...
<script>
    ...
    $(document).ready(function() {
        $(document).on('click', '.complete-btn', function(e) {
            ...
            if (confirm('Are you sure you want to mark this lot as Complete?')) {
                $.ajax({
                    url: "<?php echo e(url('admin/lots/complete')); ?>/" + lotId,
                    type: 'POST',
                    data: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u791519547/domains/mrblogician.com/public_html/ktc/resources/views/admin/pages/lots/activelotdetail.blade.php ENDPATH**/ ?>