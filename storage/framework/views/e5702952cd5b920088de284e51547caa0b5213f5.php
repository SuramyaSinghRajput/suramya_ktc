                                            ...
                                            <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input type="hidden" value="<?php echo e($module['slug']); ?>"
                                                            name="module_slug[<?php echo e($module['id']); ?>]">
                                                    </td>
                                                    <td>
                                                        <label
                                                            class="checkbox checkbox-lg checkbox-light-success checkbox-inline flex-shrink-0 m-0 mx-4">
                                                            <input type="checkbox" value="1"
                                                                <?php echo e(runTimeChecked(1, $permission)); ?>

                                                                id="Checkbox<?php echo e($module['id']); ?>"
                                                                name="permissions[<?php echo e($module['id']); ?>]"
                                                    ...
                                                    <td>
                                                        <label
                                                            ...
                                                            <input type="checkbox" value="2"
                                                                <?php echo e(runTimeChecked(2, $permission)); ?>
                                                    ...
                                                    <td>
                                                        <label
                                                            ...
                                                            <input type="checkbox" value="3"
                                                                <?php echo e(runTimeChecked(3, $permission)); ?>
                                                    ...
                                                    <td>
                                                        <label
                                                            ...
                                                            <input type="checkbox" value="4"
                                                                <?php echo e(runTimeChecked(4, $permission)); ?>
                                                    ...
                                                    <td>
                                                        <label
                                                            ...
                                                            <input type="checkbox" value="5"
                                                                <?php echo e(runTimeChecked(5, $permission)); ?>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u791519547/domains/mrblogician.com/public_html/ktc/resources/views/admin/pages/adminrole/permission.blade.php ENDPATH**/ ?>