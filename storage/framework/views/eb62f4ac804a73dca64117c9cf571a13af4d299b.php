...
<div class="header">
    ...
    <div class="d-flex">
       <?php if(in_array($permission['export'] ?? 0, [1,2,3,4,5])): ?>
            <a href="<?php echo e(route('admin.export.form')); ?>" class="btn-add">Export</a>
        <?php endif; ?>
        <?php if(in_array($permission['product'] ?? 0, [3,4,5])): ?>
...
<script>
    ...
    const permissionProduct = <?php echo e($permission['product'] ?? 0); ?>;
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u791519547/domains/mrblogician.com/public_html/ktc/resources/views/admin/pages/product/list.blade.php ENDPATH**/ ?>