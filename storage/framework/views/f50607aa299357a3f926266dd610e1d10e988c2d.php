        ...
        <div>
            ...
            <div id="lotFormModal" class="modal">
                <div class="modal-content">
                    ...
                    <form id="lotForm" action="<?php echo e(url('/admin/lots/update/' . $lots->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="product_id" class="form-select" required>
                                    ...
                                    <option value="<?php echo e($product->id); ?>" <?php echo e($product->id == $lots->product_id ? 'selected' : ''); ?>>
                                        <?php echo e($product->sku); ?> - <?php echo e($product->common_name); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u791519547/domains/mrblogician.com/public_html/ktc/resources/views/admin/pages/lots/completelotdetail.blade.php ENDPATH**/ ?>